...
def parse_arguments(parser):
    ...
    parser.add_argument('--project_root_path', type=str, default=project_root_path)
    ...
    #                     default=os.path.join(project_NLP_path, 'dataset', 'corpus', 'wikitext103-vocab.pickle'),
    #                     help='')
    parser.add_argument('--wikitext103_vocab_file', type=str,
                        default=os.path.join(project_root_path, 'datasets', 'MeaeQ', 'corpus',
                                             'wikitext103-vocab.pickle'),
                        help='')
    ...
    root = os.path.join(project_NLP_path, 'steal', 'query_and_pool')
    ...
    parser.add_argument('--pool_data_pb_file', type=str,
                        default=os.path.join(root_file, 'pool_data_pb.pickle'),
                        help='')
    ...
    parser.add_argument('--query_label_data_file', type=str,
                        default=os.path.join(root_file, 'query_label.pickle'),
                        help='')

    ############################################################################################################
    # parser.add_argument('--wiki_path', type=str,
    #                     default=os.path.join(project_NLP_path, 'dataset', 'corpus', 'wikitext103-sentences.txt'),
    #                     help='')
    # parser.add_argument('--imdb_path', type=str,
    #                     default=os.path.join(project_NLP_path, 'dataset', 'corpus', 'imdb-sentences.txt'),
    #                     help='')
    # parser.add_argument('--sst2_path', type=str,
    #                     default=os.path.join(project_NLP_path, 'dataset', 'corpus', 'sst2-sentences.txt'),
    #                     help='')
    parser.add_argument('--wiki_path', type=str,
                        default=os.path.join(project_root_path, 'datasets', 'MeaeQ', 'corpus',
                                             'wikitext103-sentences.txt'),
                        help='')
    parser.add_argument('--imdb_path', type=str,
                        default=os.path.join(project_root_path, 'datasets', 'MeaeQ', 'corpus', 'imdb-sentences.txt'),
                        help='')
    parser.add_argument('--sst2_path', type=str,
                        default=os.path.join(project_root_path, 'datasets', 'MeaeQ', 'corpus', 'sst2-sentences.txt'),
                        help='')
...
def bert_config(parser):
    ...
    parser.add_argument('--steal_bert_path', type=str,
                        default=os.path.join(project_root_path, 'LMs', 'bert_base_uncased'),
                        help='')
    parser.add_argument('--steal_bert_vocab_path', type=str,
                        default=os.path.join(project_root_path, 'LMs', 'bert_base_uncased'), help='')
    ...
    parser.add_argument('--saved_model_path', type=str, default=os.path.join(project_root_path, 'LMs', 'saved_model'),
                        help='')
...
def roberta_config(parser):
    ...
    parser.add_argument('--steal_roberta_path', type=str,
                        default=os.path.join(project_root_path, 'LMs', 'roberta_base'),
                        help='')
    parser.add_argument('--steal_roberta_vocab_path', type=str,
                        default=os.path.join(project_root_path, 'LMs', 'roberta_base'), help='')
...
def xlnet_config(parser):
    ...
    parser.add_argument('--steal_xlnet_path', type=str, default=os.path.join(project_root_path, 'LMs', 'xlnet_base'),
                        help='')
