...
import os
import transformers
from attack.SWAT.utils import *
import attack.SWAT.elitism as elitism
from attack.base_attack import BaseAttack
from attack.SWAT.args_factory import get_arguments
...
class SWAT(BaseAttack):
    ...
    def attack(self):
        ...
        # print('Aggregate rouge scores: ', rouge_total)
        # print('Full recovery rate: ', count_perfect / args.n_attacks)
        # print('Average word recovery rate: ', sum(word_recovery_rates) / args.n_attacks)
        # print('Average edit distance: ', sum(edit_distances) / args.n_attacks)
