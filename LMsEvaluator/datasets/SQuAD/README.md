## 数据集下载
数据集下载1:https://github.com/moon-hotel/BertWithPretrained/tree/main/data/SQuAD

下载后只需改名为`train.json`和`test.json`即可。

---

数据集下载2:https://rajpurkar.github.io/SQuAD-explorer/


数据集下载完成后，只需要将 `train-v1.1.json`,`dev-v1.1.json`这两个文件放到当前目录下，并改名为`train.json`和`test.json`即可！
...
> 🤔
>
> 可能需要修改生成文件为`train.json`、`test.json`
